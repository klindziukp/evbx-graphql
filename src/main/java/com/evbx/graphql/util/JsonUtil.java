...
import com.evbx.graphql.exception.ObjectMappingException;
...
public final class JsonUtil {
    ...
    public static <T> T fromJson(String json, Class<T> classOfT) {
        try {
            ...
            throw new ObjectMappingException(MODEL_MATCHING_ERROR_MESSAGE, ioEx);
        }
    }
    ...
    public static <T> String toJson(T object) {
        try {
            ...
            throw new ObjectMappingException(ioEx.getMessage(), ioEx);
        }
    }
}
